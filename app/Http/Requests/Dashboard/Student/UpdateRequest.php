...
class UpdateRequest extends FormRequest
{
    ...
    {
        // Getting the student id from the route parameter
        $studentId = $this->id;

        return [
            'name' => 'required|string|max:50',
            'nis' => 'required|string|max:6|unique:students,nis,' . $studentId,
            'nisn' => 'required|string|max:12|unique:students,nisn,' . $studentId,
